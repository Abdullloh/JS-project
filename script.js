...
// =========================function to get user infos =========================
       ...
       function userPrint(filteredUsers){
        ...
        data.forEach(item=>{
           ...
           <div id="info-container">
                 <img src="https://cdn.pixabay.com/photo/2017/03/14/03/20/nurse-2141808__340.jpg" alt="as">
                 <div class="infos">
                    <span id="doctorName">${name}</span>
                    <span id="hospitalLocation">${loca}</span>
...
// ============================Function By Filter name =========================

function filterByCityName(event){
  const value = event.target.value;
  console.log(value);
  const filteredUsers = doctorsInfo.filter(item=> item.address.city === value)
  console.log(filteredUsers);
  userPrint(filteredUsers)
}
    
function filterUser(){
  const value = document.getElementById('myInput').value;
  const filteredUsers = doctorsInfo.filter(item=>{ 
